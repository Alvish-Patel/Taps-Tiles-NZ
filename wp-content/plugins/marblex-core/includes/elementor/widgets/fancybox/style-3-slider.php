...
if ($settings['fancy_style'] === "3" && $settings['fancy_inner_style'] == 'slider') 
{
...
<div class="pt-fancy-box-slider pt-style-3 <?php echo $settings['content_align']; ?>">
    <div class="owl-carousel" <?php echo $this->get_render_attribute_string('slider'); ?>>
        ...
        foreach($tabs as $key=>$item)
        {
            ...
            ?>
            <div class="item">
                <div class="pt-fancy-box pt-style-3 <?php echo $settings['content_align']; ?>">
