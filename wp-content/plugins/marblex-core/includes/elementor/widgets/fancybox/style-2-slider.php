...
if ($settings['fancy_style'] === "2" && $settings['fancy_inner_style'] == 'slider') 
{
  ...
  <div class="pt-fancy-box-slider pt-style-2 <?php echo $settings['content_align']; ?>">
    <div class="owl-carousel" <?php echo $this->get_render_attribute_string('slider'); ?>>
        ...
        foreach($tabs as $key=>$item)
        {
            ...
            ?>
            <div class="item">
              <div class="pt-fancy-box pt-style-2  <?php echo $settings['content_align']; ?>">
                  <div class="pt-fancy-box-icon">
                      <i class="<?php echo esc_attr($item['fancy_icon']['value']) ?>" aria-hidden="true"></i>
                  </div>
