...
if ($settings['fancy_style'] === "1" && $settings['fancy_inner_style'] == 'slider') 
{
  ...
  <div class="pt-fancy-box-slider pt-style-1 <?php echo $settings['content_align']; ?>">
            ...
            <div class="item">
                <div class="pt-fancy-box pt-style-1  <?php echo $settings['content_align']; ?>">
                 ...
                 <div class="pt-fancy-box-right-icon"> 
                  <i class=" <?php echo esc_attr($item['fancy_second_icon']['value']) ?>" aria-hidden="true"></i> 
              </div>
