...
if (!class_exists('Pcfq_Theme_Verify')) {
    class Pcfq_Theme_Verify{
        ...
        public $item_id = 'envato_purchase_code_41459952';
        public  $enavto_item_id = '41459952';
        ...
        */
        ...
        public function theme_activation(){
            ...
            if (! isset( $_POST['email'] ) ||  ! isset( $_POST['purchase_code'] ) || ! isset( $_POST['security'] ) || ! wp_verify_nonce( $_POST['security'], 'purchase-activation' ) ) {
                ...
                $data['data'] = 1;
                $data['message'] = esc_html__( 'Please enter a valid field', 'marblex' );
                ...
                if(! is_email( $email ) ){
                    $data['data'] = array();
                    $data['message'] = esc_html__( 'Please enter a valid email address.', 'marblex' );
                    echo json_encode( $data );
                    wp_die();
                }
                ...
                if(empty($purchase)){
                    $data['data'] = array();
                    $data['message'] = esc_html__( 'Purchase code is empty ', 'marblex' );
                    echo json_encode( $data );
                    wp_die();
                }
                ...
                {
                       $data['data'] = array();
                        $data['message'] = esc_html__( 'Purchase code is Not Valid', 'marblex' );
                        echo json_encode( $data );
                         wp_die();
                }
                ...
                if( $return !== false ){
                    ...
                    if(isset($result['code']) && !empty($result['code']) && $result['code'] == 200){
                        ...
                        $data['message'] =  esc_html__( 'Thank you, your license has been validated', 'marblex' );
