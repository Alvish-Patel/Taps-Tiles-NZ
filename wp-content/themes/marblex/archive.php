		...
		<main id="main" class="site-main" role="main">
			<div class="container">
				...
				$flag = 1;				
					...
					if(isset($pqf_options['archive_blog_layout']) && $pqf_options['archive_blog_sidebar']  === 'no_sidebar'){
						$sidebar = false;
				...
				?>
				<div class="<?php echo esc_attr($row , 'marblex'); ?>">
					...
					<?php if ( have_posts() ){
						if($flag == 1){
							echo '<div class="'.esc_attr($mainblogcol).'">
								...
								while ( have_posts() ){
									 ...
									 */
									echo '<div class="'.esc_attr($blogcol,'marblex').'">';
						...
						if($sidebar){
						?>
							<div class="<?php echo esc_attr($sidecol , 'marblex'); ?>">
								<?php get_sidebar(); ?>
							</div>
						<?php 
